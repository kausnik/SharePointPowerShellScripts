...
3.UpdateMetadataCSV_Level2_files: The script allows you to bulk update metadata values for files in a SharePoint library based on the information provided in the CSV file. It reads the following inputs in the CSV file containing file names, folder names, and corresponding metadata values.
